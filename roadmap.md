🗂️ Roadmap Kanban — Calculadoras Ragnarok LATAM
📌 A Fazer
Organizar repositório: separar cada calculadora em sua própria pasta.

README unificado: incluir instruções gerais e links para cada calculadora.

Adicionar prints das interfaces Tkinter nos READMEs.

Changelog: registrar cada melhoria feita.

📌 Em Progresso
Exportação automática: já implementada em .txt, funcionando para Semijoias.

PurePotter: segunda calculadora já criada, em desenvolvimento paralelo.

Tratamento de erros: começar a validar entradas do usuário (ex.: impedir letras em vez de números).

📌 Concluído
Calculadora de Semijoias: interface gráfica com Tkinter, relatórios completos e exportação automática.

README individual para Semijoias e PurePotter.

Commit no GitHub com versionamento e histórico.
